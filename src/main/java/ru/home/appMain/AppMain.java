...
//        TypedQuery<Provider> query = DbHelper.getEm().createQuery("SELECT c FROM Provider c",Provider.class);
//        for (Provider provider :query.getResultList()) {
//            System.out.println("Название поставщика: " +provider.getProviderName() +
//                                "\n" + "Адрес поставщика: " + provider.getProviderAddress() +
//                                "\n" + "Номер поставщика: " + provider.getProviderId());
//        }
...
//        Payment payment3 = new Payment(paymentId++,4,600);
...
//        {
//
//            System.out.println(prov.getProviderName());
//        }
//        String s = "5 dad   dasd afg      fsda   d   d";
//        System.out.println(s.substring(0, s.matches()));
    }
}
